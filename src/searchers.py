...
def base64_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_base64(search)
...
def base58_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_base58(search)
...
def base32_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_base32(search)
    search = search.replace("=", "")
...
def base45_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_base45(search)
...
def base62_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_base62(search)
...
def base85_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_base85(search)
...
def base92_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_base92(search)
...
def hex_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_hex(search)
...
def rot_search(text: list[str], search: str, offset: int):
    text = "".join(text)
    search = encoders.encode_rot(search, offset)
...
def binary_search(text: list[str], search: str, spaces: bool):
    text = "".join(text)
    search = encoders.encode_binary(search, spaces)
...
def morse_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_morse(search)
...
def atbash_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_atbash(search)
...
def url_search(text: list[str], search: str):
    text = "".join(text)
    search = encoders.encode_url(search)
